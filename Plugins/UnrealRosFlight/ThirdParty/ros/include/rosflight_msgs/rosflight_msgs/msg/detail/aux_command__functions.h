...
#ifndef ROSFLIGHT_MSGS__MSG__DETAIL__AUX_COMMAND__FUNCTIONS_H_
#define ROSFLIGHT_MSGS__MSG__DETAIL__AUX_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * rosflight_msgs__msg__AuxCommand__init().
...
/**
 * It calls
 * rosflight_msgs__msg__AuxCommand__fini()
 ...
 * rosflight_msgs__msg__AuxCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rosflight_msgs__msg__AuxCommand__Sequence__fini()
 * on the array,
...
#endif  // ROSFLIGHT_MSGS__MSG__DETAIL__AUX_COMMAND__FUNCTIONS_H_
