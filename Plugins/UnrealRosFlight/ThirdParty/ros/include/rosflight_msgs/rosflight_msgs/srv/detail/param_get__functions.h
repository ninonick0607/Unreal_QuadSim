...
#ifndef ROSFLIGHT_MSGS__SRV__DETAIL__PARAM_GET__FUNCTIONS_H_
#define ROSFLIGHT_MSGS__SRV__DETAIL__PARAM_GET__FUNCTIONS_H_
...
/// Initialize srv/ParamGet message.
/**
...
/// Create srv/ParamGet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosflight_msgs__srv__ParamGet_Request__init().
...
/// Destroy srv/ParamGet message.
/**
 * It calls
 * rosflight_msgs__srv__ParamGet_Request__fini()
...
/// Check for srv/ParamGet message equality.
/**
...
/// Initialize array of srv/ParamGet messages.
/**
...
/// Finalize array of srv/ParamGet messages.
/**
 * It calls
 * rosflight_msgs__srv__ParamGet_Request__fini()
...
/// Create array of srv/ParamGet messages.
/**
 * It allocates the memory for the array and calls
 * rosflight_msgs__srv__ParamGet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ParamGet messages.
/**
 * It calls
 * rosflight_msgs__srv__ParamGet_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ParamGet message array equality.
/**
...
/// Copy an array of srv/ParamGet messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosflight_msgs__srv__ParamGet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosflight_msgs
...
/**
 * It calls
 * rosflight_msgs__srv__ParamGet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosflight_msgs
...
/**
 * It allocates the memory for the array and calls
 * rosflight_msgs__srv__ParamGet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosflight_msgs
...
/**
 * It calls
 * rosflight_msgs__srv__ParamGet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSFLIGHT_MSGS__SRV__DETAIL__PARAM_GET__FUNCTIONS_H_
